...
/*   Updated: 2022/04/17 18:21:20 by houazzan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_node		*initiate_linked_list(int ac, char **av, \
...
void		optimisation(t_node **stack_a, t_node **stack_b, \
			t_data *data, int len);
void		benefits(t_node **stack_a, t_node **stack_b, int type);
int			push_to_b(t_node **stack_a, t_node **stack_b, \
			t_data *data, int len);
int			push_to_a(t_node **stack_a, t_node **stack_b, \
			t_data *data, int len);
